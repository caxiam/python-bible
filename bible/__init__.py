BIBLE = [{
    ...
    'abbrs': [
        '1thes', '1thessalonians', '1thess', '1th', '1 thess', '1 thes',
        '1 th']
}, {
    'testament': 'NT',
    ...
    'abbrs': [
        '2thes', '2thessalonians', '2thess', '2th', '2 thess', '2 thes',
        '2 th']
}, {
    'testament': 'NT',
    ...
    'name': '1 Peter',
    'abbrs': [
        '1pet', '1p', '1pe', '1 pe', '1pt', '1pe', '1 pet', '1 pt', '1 pe']
}, {
    'testament': 'NT',
    'verse_counts': [21, 22, 18],
    'name': '2 Peter',
    'abbrs': [
        '2pet', '2p', '2pe', '2 pe', '2pt', '2pe', '2 pet', '2 pt', '2 pe']
}, {
    'testament': 'NT',
